      ...
      <main>
        <div  style={{
          ...
          <div style={{
            ...
            This table is maintained by a script.
            It may not reflect the latest changes and it's a bit buggy when dealing with <i>officially</i> published papers which have arXiv versions.
            The citation counts are from <a href="https://www.semanticscholar.org/author/Yuekang-Li/22799258">Semantic Scholar</a>, which are generally lower than on <a href="https://scholar.google.com/citations?user=tuJEDb4AAAAJ">Google Scholar</a>.
            The buggy information is inevitable yet acceptable. I'll fix the information from time to time manually.
          </div>
          <Table
            {...tableProps}
